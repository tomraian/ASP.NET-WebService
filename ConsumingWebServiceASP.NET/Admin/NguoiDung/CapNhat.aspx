                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <br />
                                        <asp:HiddenField ID="TenHinhAnhCu" runat="server" />
                                        <asp:Image ID="HinhAnh" runat="server" Width="200px" CssClass="mt-2 mb-2" />
                                        <%--<label for="simpleinput">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="datetime" name="name" value="" runat="server" class="form-control" ID="NgaySinh"/>
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="simpleinput">
                                            Địa Chỉ  
                                        </label>
                                        <asp:TextBox ID="DiaChi" runat="server" class="form-control"></asp:TextBox>
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="simpleinput">
                                            Số Điện thoại   
                                        ...
                                        <input type="number" name="name" value="" runat="server" class="form-control" ID="sodienthoai"/>
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="simpleinput">
                                            Giới Tính   
                                        ...
                                        <input type="number" name="name" value="" runat="server" class="form-control" ID="GioiTinh"/>
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="simpleinput">
                                            Vai Trò
